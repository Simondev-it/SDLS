...
namespace SDLS.API.Controllers
{
    ...
    public class NotificationsController : ControllerBase
    {
        ...
        [Authorize]
        [HttpPut("{id}")]
        public async Task<ActionResult<NotificationDTO>> Update(Guid id, [FromBody] NotificationUpdateDTO dto)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
        ...
        [Authorize]
        [HttpPatch("{id}")]
        public async Task<ActionResult<NotificationDTO>> SoftDelete(Guid id)
        {
        ...
        [Authorize]
        [HttpDelete("{id}")]
        public async Task<ActionResult<NotificationDTO>> HardDelete(Guid id)
        {
