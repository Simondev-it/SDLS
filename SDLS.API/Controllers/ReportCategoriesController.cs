...
namespace SDLS.API.Controllers
{
    ...
    public class ReportCategoriesController : ControllerBase
    {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<ActionResult<ReportCategoryDTO>> Create([FromBody] ReportCategoryCreateDTO dto)
        {
        ...
        //[Authorize]
        [HttpPut("{id}")]
        public async Task<ActionResult<ReportCategoryDTO>> Update(Guid id, [FromBody] ReportCategoryUpdateDTO dto)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
        ...
        //[Authorize]
        [HttpPatch("{id}")]
        public async Task<ActionResult<ReportCategoryDTO>> SoftDelete(Guid id)
        {
        ...
        //[Authorize]
        [HttpDelete("{id}")]
        public async Task<ActionResult<ReportCategoryDTO>> HardDelete(Guid id)
        {
