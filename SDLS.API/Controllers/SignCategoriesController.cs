...
namespace SDLS.API.Controllers
{
    ...
    public class SignCategoriesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<SignCategoryDTO>> Create([FromBody] SignCategoryCreateDTO dto)
        {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut("{id}")]
        public async Task<ActionResult<SignCategoryDTO>> Update(Guid id, [FromBody] SignCategoryUpdateDTO dto)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
        ...
        [Authorize(Roles = "Admin")]
        [HttpPatch("{id}")]
        public async Task<ActionResult<SignCategoryDTO>> SoftDelete(Guid id)
        {
        ...
        [Authorize(Roles = "Admin")]
        [HttpDelete("{id}")]
        public async Task<ActionResult<SignCategoryDTO>> HardDelete(Guid id)
        {
