...
namespace SDLS.Services.Services
{
    public class SimulationCategoryService : ISimulationCategoryService
    {
        ...
        public SimulationCategoryService(ISimulationCategoryRepository repository, IMapper mapper)
        {
            ...
            string? description = null)
        {
            ...
            return _mapper.Map<List<SimulationCategoryDTO>>(filtered.ToList());
        }
        ...
        public async Task<bool> CreateAsync(SimulationCategoryCreateDTO dto)
        {
        ...
        public async Task<bool> UpdateAsync(Guid id, SimulationCategoryUpdateDTO dto)
        {
            var existing = await _repository.GetByIdForUpdateAsync(id);
            if (existing == null)
                throw new KeyNotFoundException("Không tìm thấy SimulationCategory");
